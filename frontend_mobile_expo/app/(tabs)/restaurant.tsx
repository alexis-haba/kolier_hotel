...
const COLORS = {
  ...
  sub: '#9CA3AF', primary: '#10B981', border: '#27324A',
  danger: '#EF4444',
};
  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.bg }}>
      ...
      {tab === 'form' ? (
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <View style={styles.toggle}>
            <TouchableOpacity style={[styles.toggleBtn, type === 'income' && styles.toggleActive]} onPress={() => setType('income')}>
              <Text style={[styles.toggleText, type === 'income' && { color: '#0B1220' }]}>Entrées</Text>
            </TouchableOpacity>
        ...
        <ModuleHistory module="restaurant" accentColor={COLORS.primary} />
      )}
    </View>
  );
}
